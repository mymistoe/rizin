 ...
 *
 * URIs look like `vfile://3/decompressed_data_0` where `3` is the IO fd referring to the
 * RzBinFile and `decompressed_data_0` is the name of the RzBinVirtualFile inside this RzBinFile
